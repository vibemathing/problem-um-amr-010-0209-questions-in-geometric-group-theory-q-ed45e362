...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0209-questions-in-geometric-group-theory-q-ed45e362",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0209-f63c4ec5b089",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0209"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Does every Artin group have a finite $K(G,1)$?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 2.9",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "44d8ba3131f4b86dbb02d41911f949213125886f5d19543ba31ab8a938fef171"
}
```
